...
- [2026-04-10 20:07:20] Продуктовый контекст «семейная связь + рабочие ресурсы под DPI» формализован в отдельном каноническом документе `FAMILY_CONNECTIVITY_REQUIREMENTS.md`.
