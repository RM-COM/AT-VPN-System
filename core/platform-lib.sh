...
platform_transport_xhttp_tuning_profile() {
	printf '%s' "${TRANSPORT_XHTTP_TUNING_PROFILE:-default}"
}

platform_transport_reality_tuning_profile() {
	printf '%s' "${TRANSPORT_REALITY_TUNING_PROFILE:-default}"
}
