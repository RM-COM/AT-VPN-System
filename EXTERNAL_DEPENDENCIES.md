...
1. Решить, какие пользовательские ссылки на загрузки и инструкции должны остаться внешними
2. При необходимости дочистить оставшиеся fake-site шаблоны до полностью локального контента без внешних ссылок в HTML
3. При необходимости расширить `vendor/releases/` на дополнительные архитектуры и pinned-версии
