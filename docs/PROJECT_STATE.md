...
- [2026-04-10 22:10:47] Текущая ближайшая задача: закрыть `Block C1` из `XRAY_DPI_PLAN.md` и зафиксировать production-рекомендацию в формате «основной stealth-профиль + fallback-профиль».
