...
- [2026-04-09 01:10:14] Следующий практический шаг смещается на симметричный клиентский тест `stealth-xhttp`; staging после этого будет использоваться как переключаемая сравнительная нода, а не как статичный single-profile стенд.
