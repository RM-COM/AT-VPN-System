...
- [2026-04-10 23:09:41] `PLATFORM_VISION_PLAN.md` — итоговая рабочая карта идеи форка: цель, целевая архитектура, технологии, threat model, staged-план и критерии успеха.
...
- [2026-04-10 22:48:10] `PROTOCOL_HARDENING_PLAN.md` — технологический план усиления протоколов: DPI-сигнатуры, `RST`/drop resilience, `XHTTP/REALITY/AWG`, auth hardening и порядок реализации.
